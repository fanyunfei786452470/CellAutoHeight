...
- (void)configCellWithModel:(TextModel *)model {
    ...
    [self.mainLabel setLineSpace:8 withLabelText:model.title withFont:[UIFont systemFontOfSize:30] withZspace:@1.5 Width:w - 30];
    [self.descLabel setLineSpace:8 withLabelText:model.desc withFont:[UIFont systemFontOfSize:15] withZspace:@1.5 Width:w - 30];
